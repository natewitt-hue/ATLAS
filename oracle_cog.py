...
─────────────────────────────────────────────────────────────────────────────
Views, Modals, and StatsHubCog for the Oracle analytics system.
...
# These are re-imported here because Modal classes reference them directly.
# The same imports also exist in oracle_helpers.py for the _safe_sql helper.
...
class HubView(discord.ui.View):
    ...
    @discord.ui.button(
        ...
        row=0, custom_id="atlas:oracle:hotcold",
    )
    ...
    @discord.ui.button(
        ...
        row=0, custom_id="atlas:oracle:clutch",
    )
    ...
    @discord.ui.button(
        ...
        row=0, custom_id="atlas:oracle:power",
    )
    ...
    @discord.ui.button(
        ...
        row=0, custom_id="atlas:oracle:standings",
    )
    ...
    @discord.ui.button(
        ...
        row=1, custom_id="atlas:oracle:profile",
    )
    ...
    @discord.ui.button(
        ...
        row=1, custom_id="atlas:oracle:h2h",
    )
    ...
    @discord.ui.button(
        label="📅 Week Scores", style=discord.ButtonStyle.secondary,
        row=1, custom_id="atlas:oracle:recap",
    )
    ...
    @discord.ui.button(
        ...
        row=1, custom_id="atlas:oracle:draft",
    )
    ...
    @discord.ui.button(
        ...
        row=2, custom_id="atlas:oracle:players",
    )
    ...
    @discord.ui.button(
        ...
        row=2, custom_id="atlas:oracle:teamstats",
    )
    ...
    @discord.ui.button(
        ...
        row=2, custom_id="atlas:oracle:alltime",
    )
    ...
    @discord.ui.button(
        label="📅 Season Story", style=discord.ButtonStyle.success,
        row=2, custom_id="atlas:oracle:season_recap",
    )
    ...
    @discord.ui.button(
        ...
        row=3, custom_id="atlas:oracle:ask",
    )
